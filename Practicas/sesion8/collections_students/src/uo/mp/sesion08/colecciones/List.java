...
/**
 * Una colección conocida como <i>secuencia</i>). El usuario de la interfaz tiene un control preciso sobre en qué parte de la lista se encuentra cada elemento
 * insertado. El usuario puede acceder a los elementos por su índice entero (posición en
 * la lista), y buscar elementos en la lista. <p>
 */
...
{	
	 ...
	 * Devuelve {@code true} ya que las listas permiten elementos duplicados. 
	 * 
...
     *         impide que se añada a esta colección
    ...
    /**
     * Borra el elemento especificado si está en la lista. 
     * Si el elemnto no está en la lista no se modifica.
     * Más formalmente, borra el elemento con el índice más bajo{@code i} tal que 
     * {@code o == null ? get(i) == null : o.equals(get(i))} (si el elemento existe)
     * Returns {@code true} si la lista contiene el elemento especificado
     *  
     ...
     * a la derecha (se incrementan en uno los índices de los elementos desplazados).
     *
...
     *         impide que se añada a esta colección
	 ...
	 * Desplaza los elementos posteriores a la izquierda (se decrementa en uno los índices de los elementos desplazados). 
     *
	...
	/**
     * Elimina todos los elementos de esta lista (operación opcional).
     * La lista estará vacía después de la ejecución de este método.
     */
    void clear();
     ...
     * Mas formalmente, devuelve el índice más bajo {@code i} tal que
     * {@code (o == null ? get(i) == null : o.equals(get(i)))},
     * o -1 si no está el elemento.
     *
     * @param o o elemento a buscar
     * @return el índice de la primara aparición del elemento en la lista, 
     *         o -1 si la lista no contiene el elemento
     */
